		...
		buttonDelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(FrameUserManage.this, "服务器地址错误!", "提示",
							JOptionPane.INFORMATION_MESSAGE);
					return;
		...
		buttonAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (DataProcessing.searchByName(accountField.getText()) != null) {
					...
					User NewUser = new User(accountField.getText(), passwordField.getText(),
							(String) comboBoxRole.getSelectedItem());
					try {
						DataProcessing.insertUser(NewUser);
